from .base_initializer import BaseProjectInitializer
...
class ProjectInitializer(BaseProjectInitializer):
    def __init__(self):
    ...
    def create_project(self, project_path: str, template: dict) -> None:
        ...
        for dir_name, subdirs in template.items():
    ...
    def validate_template(self, template: dict) -> bool:
        return all(isinstance(v, list) for v in template.values())
